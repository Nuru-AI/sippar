...
| `thresholdSignerService` | thresholdSignerService.ts | (via icpCanisterService) | Wrapper for threshold operations |
...
├── src/
│   ├── canisters/
│   │   ├── simplified_bridge/src/lib.rs    # 662 lines — the live canister
│   │   └── threshold_signer/src/.../lib.rs # 280 lines — crypto engine
│   └── backend/
│       ├── src/server.ts                   # Express app, 5000+ lines
│       └── src/services/                   # 24 service files
├── docs/
│   ├── ARCHITECTURE.md                     # This file
│   └── STATUS.md                           # Current state + known issues
├── archive/
│   ├── canisters/ck_algo/                  # Archived monolith canister
│   └── docs/                               # 109 stale docs from Sept 2025
